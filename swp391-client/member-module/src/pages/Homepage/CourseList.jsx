...
const courses = [
  {
    ...
    image: "https://i.pinimg.com/736x/c1/d9/45/c1d9451109c037106099b1649b1e803e.jpg",
    duration: "3 Weeks",
    students: 210,
    price: "Free",
  },
...
const CourseCard = ({ course }) => (
  <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition p-4 flex flex-col border border-red-200">
