                            ...
                            <div className="md:col-span-2 bg-gray-100 p-8 rounded-lg">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm space-y-2 text-gray-600">
                                            <p className="hover:text-gray-800 cursor-pointer">About Us</p>
                                            <p className="hover:text-gray-800 cursor-pointer">What We Do</p>
                                            <p className="hover:text-gray-800 cursor-pointer">Get Involved</p>
                                            <p className="hover:text-gray-800 cursor-pointer">News And Events</p>
