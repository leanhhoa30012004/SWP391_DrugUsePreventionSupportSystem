                  ...
                  <div className="space-y-6">
                    ...
                    {courses.length === 0 ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {courses.map((course) => (
                          <div key={course.course_id} className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow" onClick={() => navigate(`/course-history/${course.course_id}`)} style={{ cursor: 'pointer' }}>
                            {course.course_img && (
                            ...
                            <div className="p-6">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <button
                                  ...
                                  className={`text-sm font-medium ${course.status === 'completed'
